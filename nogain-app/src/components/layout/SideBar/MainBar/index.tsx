    ...
    <header className={styles.leftSideBar}>
      ...
      <nav className={styles.navContainer}>
        <MenuItem
          ...
          icon={menuClient.icon}
          linkPath={menuClient.linkPath}
          
        />
        <MenuItem
          name={menuTrainingPlan.name}
          icon={menuTrainingPlan.icon}
          linkPath={menuTrainingPlan.linkPath}
      
        />
        <MenuItem
          name={menuDiscount.name}
          icon={menuTrainingPlan.icon}
          linkPath={menuDiscount.linkPath}
        
        />
        <MenuItem
          name={menuEmployee.name}
          icon={menuEmployee.icon}
          linkPath={menuEmployee.linkPath}
     
        />
        <MenuItem
          name={menuPersonalTrainer.name}
          icon={menuPersonalTrainer.icon}
          linkPath={menuPersonalTrainer.linkPath}
